    ...
    return (
        <div className="flex flex-col items-center gap-1 bg-fuchsia-900 text-fuchsia-50 rounded py-8">
            <div className="flex-1 flex flex-col items-center">
                {queryData.data ?
                    <>
                        <div className="text-xl md:text-5xl font-bold">{formatNumber(formatDecimal(Number(queryData.data), -6))} BABY</div>
                        <div className="text-sm font-medium text-fuchsia-300">{formatNumber(formatDecimal(Number(queryData.data), -6), false, 2, "T")} BABY</div>
                    </>
                    :
                    <LdrsAnimation />
                }
