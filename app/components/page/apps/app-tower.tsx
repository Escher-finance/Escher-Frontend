        ...
        <Card className="gap-6 min-h-[367px] dark:bg-escher-dark_0c203d">
            ...
            <div className="flex justify-between items-end">
                <div className="flex flex-col">
                    ...
                    {props.defi.tvl ?
                        <div className="text-escher-electricblue dark:text-white text-sm font-semibold">${formatNumber(props.defi.tvl)}</div>
                        :
                        <div className="mt-2">
