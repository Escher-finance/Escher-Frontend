    ...
    return (
        <Card className="gap-0 p-4 dark:bg-escher-dark_0c203d">
            <div className="flex flex-col dark:bg-escher-darkblue border border-escher-dedfff dark:border-escher-darkblue_border rounded-lg">
                ...
                <div className="flex items-center justify-center gap-2 py-4 border-t border-b border-escher-dedfff dark:border-escher-darkblue_border bg-gradient-to-r from-white dark:from-escher-darkblue via-white dark:via-escher-darkblue to-[#FCF9F0]">
