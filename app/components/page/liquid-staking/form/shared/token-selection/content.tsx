...
const Content = (props: Props) => {
    ...
    const groupedTokens: GroupedTokens[] = useMemo(() => {
        ...
        filteredTokens.filter(v => !v.isUniswap).map((t) => {
    ...
    return (
        <div className="flex flex-col w-full p-4">
            ...
            <div className="flex items-center">
                <button
                    className="text-escher-electricblue dark:text-white bg-escher-gray100 dark:bg-escher-dark_0c203d rounded-full flex items-center justify-center w-8 h-8 hover:bg-escher-gray200"
            ...
            <div className="flex gap-2 mt-6">
                {(step === 'chain' && selectedTokenSymbol) &&
                    <button
                        ...
                        className="flex gap-2 items-center px-2 rounded-full bg-escher-gray100 dark:bg-escher-darkblue_5 dark:text-white hover:bg-escher-gray200 transition-all text-sm font-semibold"
                    >
                        {selectedTokenLogo &&
