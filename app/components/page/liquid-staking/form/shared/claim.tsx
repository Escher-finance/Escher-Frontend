const Claim = () => {
    return (
        <div className="relative mt-6 p-6 rounded-2xl bg-linear-to-b from-[#E7E8FF] dark:from-[#142c51] to-slate-50 dark:to-[#091d3b]">
            <div className="absolute inset-0 rounded-2xl bg-[radial-gradient(50%_50%_at_50%_0%,white,transparent)] dark:hidden" />
            <div className="absolute inset-0 rounded-2xl bg-[radial-gradient(70%_70%_at_50%_0%,white,transparent)] dark:hidden" />
