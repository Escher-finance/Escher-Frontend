...
const AssetsDefiRowUniswap = (props: Props) => {
    ...
    return (
        <Accordion type="single" collapsible onValueChange={v => setOpen(v)}>
            <AccordionItem value="item-1">
                ...
                <AccordionContent
                    className="grid grid-cols-[repeat(4,auto)] gap-x-4 gap-y-2 items-center bg-escher-electricblue_light5 dark:bg-escher-darkblue px-6 py-4 text-xs"
                >
...
export default AssetsDefiRowUniswap;