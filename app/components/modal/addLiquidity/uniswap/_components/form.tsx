        ...
        <div className="min-w-[585px] flex flex-col">
            ...
            <div className="flex flex-col p-6">
                ...
                <div className="flex items-center justify-between p-6 border border-[#e4e8ed] dark:border-escher-darkblue_border rounded-lg">
                    ...
                    {/* for switching type
                        <div className="flex items-center gap-1 text-escher-777e90 bg-escher-f5f6f8 dark:bg-escher-darkblue p-1 text-sm rounded-lg font-semibold">
                            <button
                                className={`rounded-lg px-4 py-2 hover:text-gray-600 transition-all ${props.formType === "double" ? "text-escher-electricblue dark:text-white bg-escher-dedfff" : ""}`}
                                onClick={() => props.setFormType("double")}
                            >Doubled Sided</button>
                            <button
                                className={`rounded-lg px-4 py-2 hover:text-gray-600 transition-all ${props.formType === "single" ? "text-escher-electricblue dark:text-white bg-escher-dedfff" : ""}`}
                                onClick={() => props.setFormType("single")}
                            >Single Sided</button>
                        </div>
                     */}
                </div>
                                    ...
                                    <div className="flex justify-between">
                                        ...
                                        <div className="w-1/2 relative self-stretch flex items-center justify-center">
                                            <input
                                                ...
                                                className="border border-escher-dedfff dark:border-escher-darkblue_border bg-escher-f5f5ff text-escher-gray900 dark:text-white rounded-full h-full px-4 font-semibold text-2xl w-full"
                                            />
                                            <button
                                                onClick={() => {
                                                ...
                                                className="absolute right-2 text-escher-electricblue dark:text-white bg-escher-dedfff hover:bg-escher-electricblue_light8 transition-all rounded-full px-2 py-1 text-xs font-semibold"
                                            >MAX</button>
                                        </div>
                                    </div>
                ...
                {(props.formType === "single" || (props.formType === "double" && props.ratio)) &&
                    <>
                        ...
                        <div className="text-sm text-escher-777e90 mt-2 text-center">LP interaction executed via <Link href={props.defi.link} className="text-escher-electricblue dark:text-white" target="_blank">{props.defi.name}</Link> DEX, a third-party service provider.</div>
                    </>
                }
            </div >
        </div >
