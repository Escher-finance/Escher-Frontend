...
interface Props {
    ...
    statusApproval0: ProgressStatus
    statusApproval1: ProgressStatus
...
const Progress = (props: Props) => {
    ...
    const curTrace = useMemo(() => {
        ...
        if (props.statusApproval0 === "onProgress") {
            return 1 / totalPhase * 100;
        }

        if (props.statusApproval1 === "onProgress") {
        ...
        return 0;
    }, [props.statusPrepare, props.statusOperation, props.statusApproval0, props.statusApproval1]);

    return (
        <div className="w-[500px] flex flex-col bg-white dark:bg-escher-darkblue rounded-[20px]">
            ...
            <div className="flex flex-col gap-2 rounded-[20px] border border-escher-dedfff dark:border-escher-darkblue_border bg-escher-f5f6f8 p-4 m-2 mb-0 dark:bg-escher-dark_0c203d">
                ...
                <div className="flex justify-between gap-4 p-2">
                    ...
                    <Phase
                        title="STEP 2"
                        subtitle={`Approval ${props.statusApproval0 === "success" ? "2" : "1"}/2`}
                        status={props.statusApproval0 !== "success" ? props.statusApproval0 : props.statusApproval1}
                        showLine={false}
                    />
