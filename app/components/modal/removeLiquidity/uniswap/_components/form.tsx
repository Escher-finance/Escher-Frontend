        ...
        <div className="min-w-[536px] flex flex-col">
            <div className="flex justify-between items-center bg-linear-to-r from-[#FBEBC8] to-transparent rounded-t-lg p-6">
                <div className="flex-1 flex items-center gap-2 leading-none">
                    <div className="text-escher-black dark:text-white text-xl font-bold">Remove Liquidity</div>
                    <div className="flex items-center gap-1.5 rounded-full p-1 pr-2 bg-[#FAE5B9]">
                        ...
                        <div className="text-escher-text2 dark:text-white text-sm font-medium">Tower</div>
                    </div>
                </div>
                <button
            ...
            <div className="flex flex-col p-6">
                ...
                <div className="flex items-center self-start w-[110px] text-xl bg-escher-f5f5ff border border-escher-dedfff dark:border-escher-darkblue_border rounded-full px-3 py-2 mt-2">
